...
const textSecondary = purple['A200'];
...
<CardContent>
<Typography className={styles.tpgh} gutterBottom>Recovered</Typography>
<Typography variant="h5">
<CountUp start={0} end={recovered.value} duration={2.5} separator="," />
</Typography>
<Typography className={styles.tpgh}>{new Date(lastUpdate).toDateString()}</Typography>
<Typography variant="body2">Number of Active Cases recoveries from COVID-19</Typography>
</CardContent>
          </Grid>
